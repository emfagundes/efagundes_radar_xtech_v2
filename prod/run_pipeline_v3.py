...
# -*- coding: utf-8 -*-
"""
run_pipeline_v3.py — Efagundes Radar xTech | Pipeline Otimizado
...
Uso:
  ...
  python run_pipeline_v3.py --skip-coleta
  python run_pipeline_v3.py --skip-docs
  python run_pipeline_v3.py --only-docs
  python run_pipeline_v3.py --only-radar
  python run_pipeline_v3.py --only-memory
  python run_pipeline_v3.py --skip-memory
  python run_pipeline_v3.py --backfill
  python run_pipeline_v3.py --dry-run-memory
  python run_pipeline_v3.py --skip-critic    # desativa multi-LLM nesse ciclo
...
def imprimir_resumo(t_total: float) -> None:
    ...
    print(f"\n{SEP}")
    print(f"  PIPELINE v3 CONCLUÍDO — {duracao(t_total)}")
...
def main() -> None:
    ...
    print(f"\n{SEP}")
    print("  EFAGUNDES RADAR xTech — Pipeline v3")
